...
> ⛔ **Coding begins only on the owner's explicit "start development" instruction — then Phase 0, top to bottom.**
...
## When the owner says "start"

1. Re-confirm nothing in the decision log changed.
2. Execute Phase 0 top to bottom (0.1 → 0.10), then Phase 1 starting at 1.1.
