...
*(Q19 was never assigned — numbering gap, not a missing decision.)*
...
*None currently.* New owner-preference ambiguities discovered during development are appended here
